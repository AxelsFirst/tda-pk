class Matrix(object):
    ...
    def add_rows(self, index_row_to_change, index_row_to_add):
        ...
        summed_row = []
        for index in self.num_cols:
            summed_entries = (row_to_change(index) + row_to_add(index)) % 2
    ...
    def add_cols(self, index_col_to_change, index_col_to_add):
        ...
        summed_col = []
        for index in self.num_rows:
            summed_entries = (col_to_change(index) + col_to_add(index)) % 2
